...
const UpdateFlag: React.FunctionComponent = () => {
	return (
		<div className='rounded-md dark:bg-violet-900 bg-blue-100 p-2 tablet:p-3 laptop:p-4 dark:selection:bg-violet-300 dark:selection:text-black'>
			<div className='flex'>
				...
				<div className='ml-3 flex-1 md:flex md:justify-between'>
					...
					<p className='mt-1 text-sm md:ml-6'>
						<a
							href='#'
