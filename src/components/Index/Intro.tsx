						...
						<div className='sm:text-center lg:text-left'>
							...
							<div className='mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start'>
								<div className='rounded-md shadow'>
									<a
										href='#'
										className='select-none w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-teal-700 hover:bg-teal-800 md:py-4 md:text-lg md:px-10'
									>
										Trice Consultation
									</a>
								</div>
								<div className='mt-3 sm:mt-0 sm:ml-3'>
									<a
										href='#'
										className='select-none w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-rose-50 bg-rose-700 hover:bg-rose-800 md:py-4 md:text-lg md:px-10'
									>
										Conference Event
									</a>
								</div>
