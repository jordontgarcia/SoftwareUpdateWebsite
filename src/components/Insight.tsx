					...
					<div>
						...
						<div className='mt-3 sm:mt-4 lg:grid lg:grid-cols-2 lg:gap-5 lg:items-center'>
							...
							<form className='mt-6 flex flex-col sm:flex-row lg:mt-0 lg:justify-end'>
								...
								dark:bg-slate-900 dark:placeholder-gray-200 placeholder-gray-500 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 lg:max-w-xs'
								...
								<div className='mt-2 flex-shrink-0 w-full flex rounded-md shadow-sm sm:mt-0 sm:ml-3 sm:w-auto sm:inline-flex'>
									<button
										type='button'
										className='w-full dark:bg-slate-800 dark:hover:bg-slate-700 bg-blue-700 px-4 py-2 border border-transparent rounded-md flex items-center justify-center text-base font-medium 
