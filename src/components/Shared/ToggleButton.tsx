...
const ToggleButton: React.FunctionComponent = () => {
	...
	return (
		<div className='float-right'>
			<button
				type='button'
				className='z-30 select-none text-white inline-flex items-center px-4 py-3 tablet:px-3 tablet:py-2 laptop:px-3 laptop:py-2 border border-transparent text-base leading-4 font-medium rounded-md shadow-sm bg-toggle-blue bg-gray-900 dark:bg-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200'
