        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center'>
            ...
            <p className='mt-4 text-xl dark:text-gray-400 text-gray-600'>
              If you&apos;re not satisfied, kindly contact us within the first
              90 days and we&apos;ll send you a full refund.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='max-w-lg mx-auto rounded-lg shadow-lg overflow-hidden lg:max-w-none lg:flex'>
              <div className='flex-1 bg-white dark:bg-gray-900 px-6 py-8 lg:p-12'>
                <h3 className='text-2xl font-extrabold text-gray-900 dark:text-gray-200 sm:text-3xl'>
                  Lifetime Membership
                </h3>
                <p className='mt-6 text-base dark:text-gray-200 text-gray-500'>
                  Upon access, we will send you a custom welcome kit, with our
                  own designed official Trice brand clothing as a thank you. We
                  highly value our customers user experience, don&apos;t
                  hesitate to contact us if you have any questions or concerns.
                  We hope you enjoy Trice V3 and it&apos;s amazing uses, and we
                  look forward to seeing what your thoughts are! - 💖 Trice Team
                </p>
                <div className='mt-8'>
                  ...
                  >
                    {includedFeatures.map((feature) => (
                      ...
                      >
                        ...
                        <p className='ml-3 text-sm dark:text-gray-200 text-gray-700'>
                          {feature}
                        </p>
                      </li>
                    ))}
              ...
              <div className='py-8 px-6 text-center bg-gray-50 dark:bg-dark-secondary lg:flex-shrink-0 lg:flex lg:flex-col lg:justify-center lg:p-12'>
                ...
                <div className='mt-4 flex items-center justify-center text-5xl font-extrabold dark:text-gray-100 text-gray-900'>
                  <span>$3,899</span>
                  <span className='ml-3 text-xl font-medium dark:text-gray-200 text-gray-500'>
                    USD
                  </span>
                </div>
                <p className='mt-4 text-sm'>
                  <a
                    href='#'
                    className='font-medium dark:text-blue-800 text-gray-500 underline'
                  >
                ...
                <div className='mt-6'>
                  <div className='rounded-md shadow'>
                    <a
                      href='#'
                      className='flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white dark:bg-gray-900 dark:hover:bg-gray-800 bg-gray-800 hover:bg-gray-900'
                    >
                      Lifetime Access
                    </a>
                  </div>
                ...
                <div className='mt-4 text-sm'>
                  <a
                    href='#'
                    className='font-medium dark:text-gray-200 text-gray-900'
                  >
                    Free Documentation{' '}
                    <span className='font-normal dark:text-gray-200 text-gray-500'>
                      (34MB)
                    </span>
                  </a>
                </div>
