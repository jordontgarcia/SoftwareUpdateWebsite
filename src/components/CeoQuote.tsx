			...
			<div className='relative'>
			  <blockquote className='mt-10'>
				<div className='max-w-3xl mx-auto text-center text-2xl leading-9 font-medium dark:text-gray-200 text-gray-900'>
				  <p>
					“Trice is passionately committed on providing a positive
					impact for our tech world. Only together, we achieve The
					Impossible.”
				  </p>
				</div>
				<footer className='mt-8'>
				  <div className='md:flex md:items-center md:justify-center'>
					<div className='mt-3 text-center md:mt-0 md:ml-4 md:flex md:items-center'>
					  <div className='text-base font-medium dark:text-gray-200 text-gray-900'>
						Jordon Tyler Garcia
					  </div>
					  ...
					  <div className='text-base font-medium dark:text-gray-400 text-gray-500'>
